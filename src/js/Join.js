            ...
            <div className="join__front">
                ...
                <div className="join__contents">
                    ...
                    <form className='join__form' style={formIsBlock} method="POST">
                        <input className="join__form--input join__form--input-id" type="text" placeholder="아이디"  onChange={setState} name="id"/>
                        <input className="join__form--input join__form--input-pw" type="password" placeholder="비밀번호"  onChange={setState} name="pw"/>
                        <input className="join__form--input join__form--input-confirm" type="password" placeholder="비밀번호 재확인"  onChange={setState} name="repw"/>
                        <input className="join__form--input join__form--input-email" type="text" placeholder="이메일"  onChange={setState} name="email"/>
                        <input className="join__form--input join__form--input-name" type="text" placeholder="이름(실명)"  onChange={setState} name="name"/>
