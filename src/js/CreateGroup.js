...
function CreateGroup(){
    ...
    return(
        ...
        <div className="createGroup">
            ...
            <div className="menuCreateGroup" ref={menuDom}>
                <div className="menuCreateGroup__btn--home menu__btn active">
                    <svg className="menuCreateGroup__btn--icon" width="27.46" height="27.19" viewBox="0 0 27.46 27.19">
                    ...
                    <b className="menuCreateGroup__btn--name">홈</b>
                </div>
                
                <div className="menuCreateGroup__btn--group menuCreateGroup__btn">
                    <svg className="menuCreateGroup__btn--icon" width="26.502" height="26.34" viewBox="0 0 26.502 26.34">
                    ...
                    <b className="menuCreateGroup__btn--name">속한그룹</b>
                </div>

                <div className="menuCreateGroup__btn--more menuCreateGroup__btn">
                    <svg className="menuCreateGroup__btn--icon" width="26.062" height="7.415" viewBox="0 0 26.062 7.415">
                    ...
                    <b className="menuCreateGroup__btn--name">더보기</b>
                </div>
            </div>
