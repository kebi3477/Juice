...
function FindID(){
    ...
    return(
        <div className="findID">
            <div className="findID__back">
                {/* // 비밀번호찾기 배경 */}
                <svg className="findID__background" width="420" height="507.259" viewBox="0 0 420 507.259">
            ...
            <div className="findID__front">
                {/* // 아이디찾기 타이틀 */}
                <div className="findID__title">
                    <h1 className="findID__title--text">아이디 찾기</h1>
                    <h2 className="findID__subtitle--text">아래의 내용을 입력해주세요.</h2>
                </div>

                {/* // 아이디찾기 컨텐츠 */}
                <div className="findID__contents">
                    {/* // 아이디찾기 폼 */}
                    <form className="findID__form" method="POST">
                        ...
                        <button className="findID__form--input findID__form--input-findID" type="button">아이디 찾기</button>
                    </form>
